...
export default class AreaChart extends Component {
    ...
    writeCanvas(){
        ...
        this.ctx.beginPath();
        this.ctx.strokeStyle = this.props.color || '#4eb934';
        this.ctx.fillStyle = this.props.color || '#3f962a';
        ...
        for(let i=0; i<this.data.length; i++){
            ...
            //get the values
            let data =  this.data[i]; // MaxY
            let valuePercentFromMaxY = (data.y - this.minValueY)/this.maxY*100;
            let pointHeight = (data.y - this.minValueY)/this.maxY;
